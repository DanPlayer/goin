...
func EncryptUserPassword(userPass string) string {
	userPass = "###" + MD5String(MD5String(string("g39jEIs9lbmfCzqs9X"+userPass)))
	return userPass
}
...
// TimeFormat 格式化时间
func TimeFormat(timeString string) (tmp time.Time) {
